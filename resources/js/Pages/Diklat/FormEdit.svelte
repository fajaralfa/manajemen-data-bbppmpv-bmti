<script>
    ...
    const diklatId = pathname.split('/')[pathname.length - 1]
    ...
    function submitData() {
        console.log(input)
        router.put(`/diklat/${diklatId}`, input)
    }
</script>
...
<Layout>
    <div class="p-2">
        ...
        <form on:submit|preventDefault={submitData} class="flex flex-col gap-y-10 rounded-xl bg-glass-dark px-16 py-5">
