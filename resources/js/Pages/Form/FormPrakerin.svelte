        ...
        <form action="contact.php" method="POST" class="flex flex-col gap-y-6 items-center">
            <div class="input-container">
                <div>
                    ...
                    <input type="text" name="nama" class="input w-full max-w-xs" />
                </div>
                <div>
                    <label for="nama_sekolah">Nama Sekolah:</label>
                    <input type="text" name="nama_sekolah" class="input w-full max-w-xs" />
                </div>
                <div>
                    <label for="nis">NIS/NIM:</label>
                    <input type="text" name="nis" class="input w-full max-w-xs" />
                </div>
                <div>
                    <label for="bidang">Bidang Keahlian:</label>
                    <input type="text" name="bidang" class="input w-full max-w-xs" />
                </div>
                <div>
                    <label for="program">Program Keahlian:</label>
                    <input type="text" name="program" class="input w-full max-w-xs" />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="agama" class="input w-full max-w-xs" />
                </div>
                <div>
